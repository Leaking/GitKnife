package com.gitknife.github;

import android.content.Context;

import com.gitknife.library.HttpKnife;
import com.gitknife.library.Response;
...
public class GithubImpl implements Github {
    ...
    private final static String NETWORK_ERROR = "Network is not available";
    ...
    public String createToken(String username, String password)
        ...
        if (response.isSuccess() == false)
            throw new GithubError(NETWORK_ERROR);
